...
function mapInvitation(data: any): ConnectionInvitation {
  return {
    ...
    senderProfile: data.senderProfile ? {
      ...
      timezone: data.senderProfile.timezone || 'UTC',
      language: data.senderProfile.language || 'en',
      createdAt: data.senderProfile.created_at || new Date().toISOString(),
    } : undefined,
    ...
    recipientProfile: data.recipientProfile ? {
      ...
      timezone: data.recipientProfile.timezone || 'UTC',
      language: data.recipientProfile.language || 'en',
      createdAt: data.recipientProfile.created_at || new Date().toISOString(),
    } : undefined,
    status: data.status,
