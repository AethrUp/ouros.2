...
export interface IChingSlice {
  ...
  ichingInterpretation: string | IChingInterpretation | IChingInterpretationV2 | null;
  ...
  setIChingInterpretation: (interpretation: string | IChingInterpretation | IChingInterpretationV2) => void;
