// Import needed types from chart
import type { AspectType } from './chart';
...
export interface BirthData {
  ...
  timezone: string;
  // Optional quick reference fields (derived from natal chart)
  sunSign?: string;
  moonSign?: string;
  risingSign?: string;
}
...
// AspectType is defined in chart.ts - import from there if needed
